...
//returns the gross salary, NSSF, NHIF, PAYEE and net Salary
...
function salaryCal() {
    ...
    //Deducts the Nhif according to the amount of salay entered  
    ...
    //calculates the nssf by multiplying 6% of the gross salary entered 
    ...
    //calculates the net salary after deducting gross salary ,paye nssf and Nhif
    netSalary = Math.floor(grossSalary - PAYE - NSSF - NHIF);

    //returns gross salary, NSSF, NHIF, PAYEE and net Salary
